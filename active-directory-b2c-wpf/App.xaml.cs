...
namespace active_directory_b2c_wpf
{
    ...
    public partial class App : Application
    {
        ...
        /// </summary>
        public static string PolicySignUpSignIn = "<B2C Sign up or Sign in policy>";
        public static string PolicyResetPassword = "<B2C reset password policy>";
        ...
        /// </summary>
        public static string[] ApiScopes = { $"<web API 1 scope>" };

        public static string[] ApiScopes2 = { $"<web API 2 scope>" };
